...
ClapTrap::ClapTrap(std::string given_name)
{
    ...
    this->_hitPoints = 10;
    std::cout << "ClapTrap : " << given_name << " have been created with "<< this->_energyPoints << " energy point, " << this->_hitPoints << " hit point and " << this->_attackDamage  << " attack damage" << std::endl;
